With a recent issue to generate parallelism settings on each bolt, I had a better understanding of a running topology.
...
recommend for a uniform distributed workload:
